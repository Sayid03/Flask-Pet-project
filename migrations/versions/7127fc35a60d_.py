...
Revision ID: 7127fc35a60d
Revises: 
Create Date: 2025-01-22 20:31:30.490903
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('login', sa.String(length=80), nullable=True))
